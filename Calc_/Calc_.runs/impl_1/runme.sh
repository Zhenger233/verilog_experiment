...
HD_PWD='D:/word/Tencent Files/2042712521/FileRecv/Calc_/Calc_.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cal.tcl -notrace

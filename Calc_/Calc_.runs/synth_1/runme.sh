...
HD_PWD='D:/word/Tencent Files/2042712521/FileRecv/Calc_/Calc_.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cal.tcl

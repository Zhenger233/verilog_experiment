...
HD_PWD='D:/project/vvd/DigitalTask1_74x151/DigitalTask1_74x151.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log f.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source f.tcl -notrace

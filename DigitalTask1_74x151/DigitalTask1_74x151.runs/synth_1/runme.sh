...
HD_PWD='D:/project/vvd/DigitalTask1_74x151/DigitalTask1_74x151.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log f.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source f.tcl

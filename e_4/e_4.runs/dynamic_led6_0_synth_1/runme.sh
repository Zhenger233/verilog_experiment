...
HD_PWD='D:/project/vvd/e_4/e_4.runs/dynamic_led6_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamic_led6_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dynamic_led6_0.tcl

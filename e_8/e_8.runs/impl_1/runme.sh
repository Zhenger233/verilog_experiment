...
HD_PWD='D:/project/vvd/e_8/e_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chessClock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chessClock.tcl -notrace

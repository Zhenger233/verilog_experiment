...
HD_PWD='D:/project/vvd/e_8/e_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chessClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chessClock.tcl

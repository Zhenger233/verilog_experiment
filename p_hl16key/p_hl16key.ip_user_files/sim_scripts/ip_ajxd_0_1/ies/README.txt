...
#
# Generated by export_simulation on Tue Jan 30 23:36:23 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './ip_ajxd_0.sh' script.

./ip_ajxd_0.sh -reset_run
...
./ip_ajxd_0.sh -noclean_files

For more information on the script, please type './ip_ajxd_0.sh -help'.

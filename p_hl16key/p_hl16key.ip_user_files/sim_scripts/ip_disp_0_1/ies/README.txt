...
#
# Generated by export_simulation on Mon Jun 11 15:55:34 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './ip_disp_0.sh' script.

./ip_disp_0.sh -reset_run
...
./ip_disp_0.sh -noclean_files

For more information on the script, please type './ip_disp_0.sh -help'.

...
HD_PWD='C:/Users/Zhenger/Desktop/p_hl16key/p_hl16key.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log divclk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divclk.tcl -notrace

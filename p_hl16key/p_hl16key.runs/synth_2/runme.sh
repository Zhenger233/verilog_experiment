...
HD_PWD='C:/Users/Zhenger/Desktop/p_hl16key/p_hl16key.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log divclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divclk.tcl
